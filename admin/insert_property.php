...
if($property_owner == '' || $city == '' || $locality == '' || $property_type =='' || $address =='' || $twin_price == '' ||  $solo_price == ''){
    ...
    //insert qurey
    $insert_property = "INSERT INTO `properties`(`property_owner`, `city`, `locality`, `property_type`, `property_address`, `twin_sharing_price`, `solo_room_price`, `property_image` , `property_image2`, `property_image3`) 
    VALUES ('$property_owner','$city','$locality','$property_type','$address','$twin_price','$solo_price','$property_image','$property_image2','$property_image3')";
...
<form method="post" action="" enctype="multipart/form-data" style="border: 1px solid gray; border-radius: 10px; padding: 1rem;" class="row g-3 mt-5 needs-validation  justify-content-center align-items-center  border-2  w-50 pt-5 " novalidate>
        ...
        <div class="col-md-4 position-relative">
            ...
            <input type="text" class="form-control" id="validationTooltip02" name="twin_price" placeholder ="Twin Sharing Price" required>
        </div>
        <div class="col-md-4 position-relative">
